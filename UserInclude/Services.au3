...
Global Const $SERVICE_READ_CONTROL = 0x20000
Global Const $SERVICE_WRITE_DAC = 0x40000
Global Const $SERVICE_WRITE_OWNER = 0x80000

Global 	$SERVICE_STANDARD_RIGHTS_REQUIRED = BitOR( $DELETE, _
										$SERVICE_READ_CONTROL, _
										$SERVICE_WRITE_DAC, _
										$SERVICE_WRITE_OWNER )
...
;~ BitOR( $SERVICE_STANDARD_RIGHTS_REQUIRED, _
...
; Service start types
Global Const $SERVICE_Default = 0x00000000
