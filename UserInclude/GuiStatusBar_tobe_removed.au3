...
; #FUNCTION# ====================================================================================================================
; Name...........: _GUICtrlStatusBar_SetFont
; Description ...: Sets the font of the text in the status window
; Syntax.........: _GUICtrlStatusBar_SetText($hWnd, $iHeight = 15, $iWeight = 400, $iFontAtrributes = 0, $sFontName = "Arial")
; Parameters ....: $hWnd        - Handle to the control
;                  $iHeight     - The Weight of the text 
;                  $iWeight     - The height of the text 
;                  $iFontAtrributes  - The Atrributes of the font
...
Func _GUICtrlStatusBar_SetFont($hWnd, $iHeight = 15, $iWeight = 400, $iFontAtrributes = 0, $sFontName = "Arial")
	Local $ret = _WinAPI_CreateFont($iHeight, 0, 0, 0, $iWeight, BitAND($iFontAtrributes, 2), BitAND($iFontAtrributes, 4), _
			BitAND($iFontAtrributes, 8), $DEFAULT_CHARSET, $OUT_DEFAULT_PRECIS, $CLIP_DEFAULT_PRECIS, _
			$DEFAULT_QUALITY, 0, $sFontName)

	Return _SendMessage($hWnd, $WM_SETFONT, $ret, 1)
