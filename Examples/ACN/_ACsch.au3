...
Func _Main()
  ...
  ; 创建界面
  $hGUI = GUICreate("Inverse Hyperbolic Cosecant", 400, 300)
  $hWnd = WinGetHandle("Inverse Hyperbolic Cosecant")
  GUISetState()
  ...
  _GDIPlus_GraphicsDrawStringEx($hGraphic, 'Inverse Hyperbolic Cosecant', $hFont, $tLayout, $hFormat, $hBrush)
