...
Func _Main()
	Local $hGUI, $hWnd, $hGraphic, $hBrush, $tLayout1, $hFormat, $hFamily, $hFont, $tLayout, $hPen, $aPoint2[401][2], $aPoint1[401][2],  $j = 1, $m = 1

	; 创建界面
	$hGUI = GUICreate("Inverse Exsecant", 400, 300)
	$hWnd = WinGetHandle("Inverse Exsecant")
	GUISetState()
	...
	_GDIPlus_GraphicsDrawStringEx($hGraphic, 'Inverse Exsecant', $hFont, $tLayout1, $hFormat, $hBrush)
