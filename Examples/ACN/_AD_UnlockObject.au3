...
Global $iReply = msgbox(308, "Active Directory Functions", "This script unlocks the specified object (user account, computer account)." & @CRLF & @CRLF & _
...
GUICtrlCreateLabel("Object to unlock (FQDN or sAMAccountName):", 8, 10, 231, 17)
Global $IObject = GUICtrlCreateInput("", 241, 10, 459, 21)
Global $BOK = GUICtrlCreateButton("Unlock object", 8, 72, 121, 33)
...
; 改变对象
Global $iValue = _AD_UnlockObject($sObject)
If $iValue = 1 Then
