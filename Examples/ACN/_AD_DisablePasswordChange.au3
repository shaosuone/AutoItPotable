...
Global $iReply = msgbox(308, "Active Directory Functions", "This script denies ability to change the password for the specified user." & @CRLF & @CRLF & _
...
; 改变用户
Global $iValue = _AD_DisablePasswordChange($sUser)
If $iValue = 1 Then
