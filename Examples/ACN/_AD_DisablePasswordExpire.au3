...
Global $iReply = msgbox(308, "Active Directory Functions - Example 1", "This script sets the password for the specified user to not expire." & @CRLF & @CRLF & _
...
; 改变用户
Global $iValue = _AD_DisablePasswordExpire($sUser)
If $iValue = 1 Then
