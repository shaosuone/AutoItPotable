...
Func _Example()
	...
	; 绘制图像, 显示青色通道强度
	_GDIPlus_ImageAttributesSetOutputChannel($hIA, 0, True, 0) ; 青色
	_GDIPlus_GraphicsDrawImageRectRectIA($hGraphics, $hBitmap, 0, 0, $iWidth, $iHeight, 0, 0, @DesktopHeight / 2, @DesktopHeight / 2, $hIA)

	; 绘制图像, 显示洋红色通道强度
	_GDIPlus_ImageAttributesSetOutputChannel($hIA, 0, True, 1) ; 洋红色
	...
	; 绘制图像, 显示黄色通道强度
	_GDIPlus_ImageAttributesSetOutputChannel($hIA, 0, True, 2) ; 黄色
	...
	; 绘制图像, 显示黑色通道强度
	_GDIPlus_ImageAttributesSetOutputChannel($hIA, 0, True, 3) ; 黑色
