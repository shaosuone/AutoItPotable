...
Func _Main()
  ...
  ; 创建界面
  $hGUI = GUICreate("Excosecant", 400, 300)
  $hWnd = WinGetHandle("Excosecant")
  GUISetState()
  ...
  $hFormat = _GDIPlus_StringFormatCreate()
	...
	$tLayout = _GDIPlus_RectFCreate(20, 200, 200, 20)
	_GDIPlus_GraphicsDrawStringEx($hGraphic, 'Excosecant', $hFont, $tLayout, $hFormat, $hBrush)
