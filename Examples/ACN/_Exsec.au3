...
Func _Main()
	...
	; 创建界面
	$hGUI = GUICreate("Exsecant", 400, 300)
	$hWnd = WinGetHandle("Exsecant")
	GUISetState()
	...
	_GDIPlus_GraphicsDrawStringEx($hGraphic, 'Exsecant', $hFont, $tLayout, $hFormat, $hBrush)
